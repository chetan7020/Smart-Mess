package com.safar.smartmessdevhacks.owner;
...
import com.safar.smartmessdevhacks.databinding.ActivityOwnerMainBinding;
...
public class OwnerMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_dashboard, R.id.navigation_notifications, R.id.navigation_manage_coupon)
                .build();
